    ...
    <div className="aboutPrism">
      <div className="prismText" data-aos="fade-right">
        ...
        <div className="prismText-text">
          ...
          ecosystems such as Ethereum BSC, and has the characteristics of high effi
          -ciency, convenience, and security.
        </div>
        <div className="prismText-text">
          Developers will be able to develop and deploy DeFi applications on Prism
          Network simply, quickly and at low cost. Prism Network's cross-chain cap
          -abilities can help DeFi applications gain better liquidity and more ecologi
          -cal users.
        </div>
      </div>
